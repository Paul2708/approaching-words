    ...
    return (
        <div className="p-8 min-h-screen">
            ...
            <div className="font-header flex flex-col items-center pt-8">
                ...
                <div className="pt-5">
                    After <span className="font-bold">14 tries</span>, you and SharebinAPI came up with the word <span
                    className="text-[#FFDD00] font-bold">apple</span>.
                </div>
            </div>
                ...
                <div className="w-full max-w-4xl bg-[#CA7C7C] text-white shadow-lg rounded">
                    <div className="flex flex-col w-full">
                        <div className="flex w-full">
                            <div className="w-1/3 p-2 text-center">Column 1, Row 1</div>
                            <div
                                    ...
                                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g id="SVGRepo_iconCarrier">
                                            <path
                                                ...
                                                fill="#FFDD00"></path>
                                            <path opacity="0.5" d="M5 17.5H19" stroke="#FFDD00" stroke-width="1.5"
                                                  stroke-linecap="round"></path>
                                        </g>
                                    </svg>
                                </div>
                            </div>
                            <div className="w-1/3 p-2 text-center blur-sm">abcdefghi</div>
                        </div>
